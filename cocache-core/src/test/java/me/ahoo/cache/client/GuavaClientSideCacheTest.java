 ...
 * @author ahoo wang
 */
class GuavaClientSideCacheTest {
    GuavaClientSideCache<String> clientSideCaching = new GuavaClientSideCache<>();
    ...
    @Test
    void clear() {
        final String CACHE_KEY = "clear";
        final String CACHE_VALUE = "clear";
        clientSideCaching.set(CACHE_KEY, CACHE_VALUE);
