...
CoCache 使用 **Gradle 9.4.1** 的 Kotlin DSL，所有库模块均面向 **JDK 17+**。构建流水线集成了 Detekt 进行静态分析、Dokka 生成 API 文档、JaCoCo 进行代码覆盖率统计，以及 GitHub Actions 实现持续集成和部署。
...
Gradle Wrapper 固定为 Gradle 9.4.1：
